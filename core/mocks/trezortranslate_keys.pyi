...
class TR:
    ...
    address__coin_address_template: str = "{0} address"
    ...
    ble__forget_all_success: str = "All devices removed."
    ...
    ble__forget_this_success: str = "Device removed."
    ...
    cardano__choose_level_of_details: str = "Choose level of detail:"
    ...
    cardano__key_path: str = "key path"
    ...
    ethereum__title_input_data: str = "Data"
    ...
    fido__does_not_belong: str = "The credential you are trying to import does not belong to this authenticator."
    ...
    homescreen__settings_title: str = "Wallpaper"
    ...
    instructions__continue_holding: str = "Keep holding"
    ...
    instructions__menu_to_continue: str = "Use menu to continue"
    ...
    instructions__shares_start_with_x_template: str = "Start with share {0}"
    ...
    passphrase__access_hidden_wallet: str = "Access Passphrase wallet"
    ...
    passphrase__hidden_wallet: str = "Passphrase wallet"
    ...
    plurals__days: str = "day|days"
    plurals__hours: str = "hour|hours"
    plurals__milliseconds: str = "millisecond|milliseconds"
    plurals__minutes: str = "minute|minutes"
    plurals__seconds: str = "second|seconds"
    ...
    recovery__dry_run_bip39_valid_match: str = "The entered wallet backup is valid and matches the one on this device."
    recovery__dry_run_bip39_valid_mismatch: str = "The entered wallet backup is valid but doesn't match the one on this device."
    recovery__dry_run_slip39_valid_match: str = "The entered wallet backup is valid and matches the one on this device."
    recovery__dry_run_slip39_valid_mismatch: str = "The entered wallet backup is valid but doesn't match the one on this device."
    ...
    recovery__share_from_group_entered_template: str = "Share {0} of group {1} entered."
    ...
    reset__check_group_share_title_template: str = "Share {1} of group {0}"
    reset__check_share_backup_template: str = "Let's do a quick check of share {0}."
    ...
    reset__group_share_checked_successfully_template: str = "Share {1} of group {0} checked successfully."
    reset__group_share_title_template: str = "Share {1} of group {0}"
    ...
    reset__num_of_shares_long_info_template: str = "Each backup share is a sequence of {0} words.\nStore each wordlist in a separate, safe location or share with trusted individuals. Collect as needed to recover your wallet."
    reset__num_shares_for_group_template: str = "Number of shares required to form group {0}."
    reset__number_of_shares_info: str = "= total number of shares used for wallet backup."
    ...
    reset__select_word_from_share_template: str = "Select word {0} from share {1}"
    ...
    reset__slip39_checklist_more_info_threshold: str = "Threshold sets minimum number of shares needed to recover your wallet."
    reset__slip39_checklist_more_info_threshold_example_template: str = "If you set it to {0} out of {1} shares, the number of shares needed to recover your wallet will be {0}."
    ...
    reset__threshold_info: str = "= minimum number of shares used for recovery."
    ...
    solana__max_fees_rent: str = "Max fees and rent"
    solana__max_rent_fee: str = "Max rent fee"
    solana__multiple_signers: str = "Multiple signers"
    solana__offchain_is_multisig: str = "The following message requires multiple signers."
    ...
    stellar__ext_auth_message: str = "Transaction contains externally authorized invocations."
    ...
    tutorial__last_one: str = "Last one"
